const Todo = ({ todo, handleSetComplete, handleDelete }) => {
    ...
    return (
        <div className="flex item-center justify-between p-4 pl-2 bg-gray-700 border-b border-solid border-gray-600">
            ...
            <img onClick={() => handleDelete(id)} className="h-5 w-5 cursor-pointer transition-all duration-300 ease-in" src="/close-icon.svg" alt="icono de cerrar"/>
        </div>
    );
